...
(function() {
  ...
  function isDarkMode() {
    return document.body.classList.contains('dark-mode') ||
           ...
           document.querySelector('#article-container')?.classList.contains('dark') ||
  ...
  function getThemeColors() {
    ...
    return {
      ...
      splitLine: dark ? '#334155' : '#E2E8F0',
      // 文字颜色
      textPrimary: dark ? '#E2E8F0' : '#1E3A8A',
      textSecondary: dark ? '#94A3B8' : '#475569',
      // 图表颜色
      primary: dark ? '#60A5FA' : '#1E40AF',
      primaryLight: dark ? '#93C5FD' : '#3B82F6',
      primaryGlow: dark ? 'rgba(96, 165, 250, 0.3)' : 'rgba(30, 64, 175, 0.3)',
      accent: dark ? '#FBBF24' : '#F59E0B',
      // 背景
      chartBg: dark ? 'rgba(30, 64, 175, 0.05)' : 'rgba(30, 64, 175, 0.02)',
      // 饼图边框
      pieBorder: dark ? '#1E293B' : '#fff'
    };
  }
      ...
      series: [{
        ...
        areaStyle: {
          color: {
            ...
            x: 0, y: 0, x2: 0, y2: 1,
            colorStops: [
              { offset: 0, color: colors.primaryGlow },
  ...
  function renderTagsChart(data) {
    ...
    const chartColors = ['#60A5FA', '#3B82F6', '#1E40AF', '#93C5FD', '#BFDBFE',
  ...
  function renderCategoriesChart(data) {
    ...
    const chartColors = ['#60A5FA', '#3B82F6', '#1E40AF', '#93C5FD', '#BFDBFE',
                    '#FBBF24', '#F59E0B', '#FCD34D', '#10B981', '#8B5CF6'];
    const option = {
      tooltip: {
        trigger: 'item',
        backgroundColor: 'rgba(30, 64, 175, 0.9)',
